...
const CurrencySelect = styled(ButtonGray)<{
  ...
  align-items: center;
  background-color: ${({ selected, theme }) => (selected ? "theme.surface1" : "#6E42CA")};
  ...
  outline: none;
  user-select: none;
  border: 1px solid ${({ selected, theme }) => (selected ? theme.surface3 : "#6E42CA")};
  font-size: 24px;
  font-weight: 485;
  width: ${({ hideInput }) => (hideInput ? '100%' : 'initial')};
  ...
  &:hover,
  &:active {
    background-color: ${({ theme, selected }) => (selected ? theme.surface2 : "#6E42CA")};
  }
